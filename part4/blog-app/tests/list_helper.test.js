...
describe("total likes", () => {
  ...
  test("correctly adds two blog posts", () => {
    const result = listHelper.totalLikes(listWithTwoBlogs);
    expect(result).toBe(12);
  });

  test("correctly add multiple blog posts", () => {
...
describe("favorite blogs", () => {
  ...
  test("prints blog with most likes of two", () => {
  ...
  test("prints blog with most likes", () => {
...
describe("most blogs written", () => {
  ...
  test("print author with most blogs short list", () => {
  ...
  test("prints author with most blogs", () => {
